...
public class MainActivity extends AppCompatActivity {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.email) {
            ...
            i.putExtra(Intent.EXTRA_SUBJECT, getString(R.string.Добавьте_еще_холодильник));
            i.putExtra(Intent.EXTRA_TEXT, getString(R.string.Предлагаю_такой_холодильник));
            try {
